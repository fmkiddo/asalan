							...
							<div class="card-body">
								<div class="control-section">
									...
									<div class="card-control">
										...
										<a role="button" href="#tableFATransfer" data-bs-reload="table" title="{tooltip0}">
										...
										<form method="post">
											...
											<div class="form-group">
												<div class="input-group">
													...
													<button type="button" id="fatAddAsset" class="btn btn-outline-primary" title="{popup1}" data-action="open-dialog" data-action-target="#modal_faTransferSelect" data-action-source="#locationSource">
										...
										<div id="modal_faTransferSelect" class="modal fade" role="dialog" tabindex="-1" data-bs-keyboard="false" data-bs-background="static">
											<div class="modal-dialog modal-xl">
												<div class="modal-content">
													...
													<div class="modal-body">
														<div class="form-group">
															<select id="select_fatAsset" class="form-control" data-action="do-filter" data-filter-target="#table_fatAssetOpt">
																<option value="" selected>---- {dsbopt2} ----</option>
															</select> 
														</div>
														<hr class="separator" />
														<table id="table_fatAssetOpt" class="table table-hover table-striped table-centered" role="button" data-table="true" data-sub="asset-picks" data-sub-target=""  data-sub-type="sublocations" data-sub-filter="" data-ordering="false" data-target="#tableAssetTransfer">
															<thead>
																<tr>
																	<th>#</th>
																	<th>{mdl_th0}</th>
